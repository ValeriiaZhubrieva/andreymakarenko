...
if (iconMenu != null) {
	let delay = 500;
	let menuBody = document.querySelector(".header__menu-list");
...
let slider_diplom = new Swiper('.diploms__items', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.diploms__arrows .arrow_next',
		prevEl: '.diploms__arrows .arrow_prev',
	},
...
let slider_reviews = new Swiper('.reviews__items', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.reviews__arrows .arrow_next',
		prevEl: '.reviews__arrows .arrow_prev',
	},
	/*
	breakpoints: {
		320: {
...
let slider_inst = new Swiper('.instagram__items', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.instagram__arrows .arrow_next',
		prevEl: '.instagram__arrows .arrow_prev',
	},
